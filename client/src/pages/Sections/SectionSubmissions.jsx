...
import { useSectionSubmission } from '../../services/useSubmissions'
...
const SectionSubmissions = () => {
    const {isLoading, submissions} = useSectionSubmission()
    ...
    <div className='my-3 px-10 grid grid-cols-[1fr_15rem] gap-5'>
        ...
        columns={
            ...
            },
          {
            dataIndex: 'problem',
            title: 'Mesele',
            render: (p,_)=> <Link to={`/sections/${_?.subsection?.section}/${_?.subsection?._id}/${p?._id}`}> {p?.title} </Link> 
          },
          {
            title: 'Netije',
            dataIndex:'verdict',
...
export default SectionSubmissions