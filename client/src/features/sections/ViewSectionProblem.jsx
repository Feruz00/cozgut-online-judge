      ...
      <div className='flex w-full flex-col py-4 shadow my-3'>
            ...
            <div className='px-3'>
                ...
                <Table 
                    ...
                    dataSource={problem.inputExample.map( (i, index)=>({key: i._id,input: i, output: problem.outputExample[index]}) )}
                />
                </div>
            </div>
            <div className='px-3'>
...
export default ViewSectionProblem